...
<div id="fh5co-title-box" style="background-image: url({{asset('images/camila-cordeiro-114636.jpg')}}); background-position: 50% 90.5px;" data-stellar-background-ratio="0.5">
    ...
    <div class="container paddding">
        <div class="row mx-0">
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img src="{{asset('images/allef-vinicius-108153.jpg')}}" alt="img" class="fh5co_most_trading"/>
                    </div>
                    <div class="col-7 paddding">
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img src="{{asset('images/download (2).jpg')}}" alt="img" class="fh5co_most_trading"/>
                    </div>
                    <div class="col-7 paddding">
                        <div class="most_fh5co_treding_font"> Magna aliqua ut enim ad minim veniam quis nostrud.</div>
                        <div class="most_fh5co_treding_font_123"> April 18, 2016</div>
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center"><img src="{{asset('images/seth-doyle-133175.jpg')}}" alt="img"
